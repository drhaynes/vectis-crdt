...
This removes the old JS render-buffer parsing path. The only JavaScript in `crates/wasm_demo/index.html` is the module loader generated by `wasm-pack` plus a tiny `init()` call.
